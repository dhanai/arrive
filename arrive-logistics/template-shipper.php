        ...
        <div class="m-wrapper">
            <div class="technology-intro">
                <div class="technology-intro-text">
                    <h2 class="section-headline"><?php the_field('sbd_headline'); ?></h2>
                    <p><?php the_field('sbd_content'); ?></p>
                </div>
            ...
            <div class="ms-wrapper">
                <div class="technology-accordion">
                    ...
                    <?php $cnt=0; if( have_rows('tp_service_bullet') ):  while ( have_rows('tp_service_bullet') ) : the_row(); $cnt++; ?>
            			...
            			<dt><a href="" style="background-image:url(<?php the_sub_field('bullet_icon'); ?>);"><?php the_sub_field('bullet_title'); ?></a></dt>
    	...
    	<div class="big-wrapper"> 
            <div class="quote-area">
               <div class="quote-image mobile-show" style="background-image: url(<?php the_field('tp_qb_image'); ?>);"></div><!--quote image-->
                ...
                <div class="quote-image d-hide" style="background-image: url(<?php the_field('tp_qb_image'); ?>);"></div><!--quote image-->
                <div class="clear"></div>
            </div><!--quote area-->
    	</div><!--big wrapper-->
    </section>
